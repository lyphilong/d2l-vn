...
Lưu ý rằng $\mathbf{w}$ và $\mathbf{x}$ là các vector. Ở đây, việc ký hiệu bằng các vector làm cho công thức dễ đọc hơn nhiều so với ta diễn đạt công thức bằng các hệ số như  $w_1, w_2, \ldots, w_d$.
*dịch đoạn phía trên*
